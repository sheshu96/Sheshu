...
def search_record():
	...
	for record in root.findall('Record'):
			is_record_found = check_status_and_id_of_given_record(record)
...
def update_record():
	...
	for record in root.findall('Record'):
		...
		if is_record_found == True:
			...
			print("Enter " + field_names[int(updatable_fields[option - 1]) - 1] + ': ')
...
def check_status_and_id_of_given_record(record):
